...
func (p *MessageServiceClient) MessageAction(ctx context.Context, req *DouyinMessageActionRequest) (r *DouyinMessageActionResponse, err error) {
...
var MessageServiceMessageActionArgs_Req_DEFAULT *DouyinMessageActionRequest

func (p *MessageServiceMessageActionArgs) GetReq() (v *DouyinMessageActionRequest) {
	if !p.IsSetReq() {
		return MessageServiceMessageActionArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *MessageServiceMessageActionArgs) SetReq(val *DouyinMessageActionRequest) {
	p.Req = val
}
